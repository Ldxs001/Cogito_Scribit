...
| **下载 EPUB（电子书）** | `build/output/book.epub`（或独立发行版 **book-v1.0.0**：<https://github.com/Ldxs001/Cogito_Scribit/releases/tag/book-v1.0.0>，Gitee 同 tag） |
| **下载 HTML（网页版）** | `build/output/book.html`（或独立发行版 **book-v1.0.0** 附件） |
