...
# 书的结构（顺序即书的顺序；排版 01~05 五层、06 规范层、07 管线层按流水线排序，排版 08 为收束篇殿后）
...
STRUCTURE = [
    ...
    ("articles/成书排版（六）：规范排版——条文之家与族系工程.md", "排版 06 · 规范排版", "06｜成书排版：规范排版——条文之家与族系工程"),
    ("articles/成书排版（七）：管线排版——规则入脚本与固定化转换.md", "排版 07 · 管线排版", "07｜成书排版：管线排版——规则入脚本与固定化转换"),
    ("articles/AI任务执行的完整流程——明确位置、对齐粒度、穷举正反例.md", "排版 08 · AI 任务执行的完整流程", "08｜AI 任务执行的完整流程——明确位置、对齐粒度、穷举正反例"),
    ("99_结语.md", "结语", None),
