...
十一篇编号文章 + 一篇操作层 + 一篇检索层注脚，一个闭环、一种架构范式：
...
**01 → 02 → 03 → 04 → 05 → 06 → 07 → 08 → 08a → 09 → 09a**（09 为边界篇，09a 为 09 的检索层注脚，依赖关系与定位见 COGITO_README）；**10 → 10a 为认知重估篇**（跨全系列的元审视：10 讲让渡与力气活终结，10a 讲让渡之后必须画圈——伦理牢笼。可通读全系列后阅读，也可独立阅读）
