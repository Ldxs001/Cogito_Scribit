...
本目录是书族系**规范之家**，收录全部族系规范与排版方法论：单篇写作规范（STYLE_GUIDE）、转化入书规范（STRUCTURE_GUIDE）、书籍结构规范（成书规范）与成书排版系列文章（articles/）——三份规范各司其职，族系唯一，各仓不持有规范文件。2026-09-01 自仓库根拆出并汇编姊妹册，规范文件历史提交保留（git mv）。
...
| [成书规范.md](成书规范.md) | 书籍结构规范（书内骨架 / 文件夹布局 / 文件命名 / 新册创建清单） | 规范 |
