...
| **下载 PDF / HTML / EPUB** | 发行版 **typ-v1.6.1**（[Gitee](https://gitee.com/wUwproject/Cogito_Scribit/releases/tag/typ-v1.6.1) / [GitHub](https://github.com/Ldxs001/Cogito_Scribit/releases/tag/typ-v1.6.1)，含 PDF 打印版） |
...
全册规模与版本见 `frontmatter/00_版权页.md`（当前 typ-v1.6.1，13 章）。
